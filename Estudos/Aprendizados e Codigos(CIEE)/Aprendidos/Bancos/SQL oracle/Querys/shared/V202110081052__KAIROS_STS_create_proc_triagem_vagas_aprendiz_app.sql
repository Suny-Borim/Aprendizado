create or replace PROCEDURE                   "PROC_TRIAGEM_VAGAS_APP_APRENDIZ"(v_id_estudante NUMBER,
...
BEGIN
    ...
    OPEN V_RESULTSET FOR L_QUERY USING V_ID_ESTUDANTE, V_IDADE_ESTUDANTE, V_VALOR_REMUNERACAO_DE, V_VALOR_REMUNERACAO_DE, V_VALOR_REMUNERACAO_ATE, V_VALOR_REMUNERACAO_ATE, V_OFFSET, V_NEXT;
