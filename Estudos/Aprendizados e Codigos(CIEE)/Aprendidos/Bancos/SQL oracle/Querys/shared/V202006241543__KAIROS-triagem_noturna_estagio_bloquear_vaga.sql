...
BEGIN
    ...
    FOR c_vaga IN (SELECT codigo_da_vaga FROM SERVICE_VAGAS_DEV."TRIAGENS_VAGAS" WHERE TIPO_VAGA = 'E' and  (ID_SITUACAO_VAGA = 1 or (ID_SITUACAO_VAGA = 2 and POSSUI_OCORRENCIAS =0))
        ...
        LOOP
            ...
            FROM
                (SELECT /*+ PARALLEL(8) */
                 ...
                 WHERE
                   ...
                   AND NOT EXISTS (SELECT 1 FROM SERVICE_VAGAS_DEV.VINCULOS_VAGA t WHERE t.codigo_vaga = V.codigo_da_vaga AND t.id_estudante = E.ID_ESTUDANTE AND t.deletado = 0 AND t.SITUACAO_VINCULO <> 3)
                   AND NOT EXISTS (SELECT 1 FROM
                     SERVICE_VAGAS_DEV.VINCULOS_VAGA t
            ...
            -- mudando situacao de vaga para bloqueada em caso de saldo atingido
            IF (stage_objetivo_vaga (V_CODIGO_DA_VAGA) = 0) THEN
