 CREATE OR REPLACE VIEW "SERVICE_VAGAS_DEV"."V_DADOS_ESTAGIARIOS_ICN" ("ID", "NOME", "CPF", "CODIGO_ESTUDANTE", "DATA_CRIACAO", "DATA_ALTERACAO", "EMAIL", "DATA_NASCIMENTO", "RG", "SEXO", "UF_RG", "ORGAO_EMISSOR_RG", "ID_UNIDADE", "SITUACAO", "ID_AGENCIA", "ID_BANCO", "CONTA_CORRENTE", "CONTA_CORRENTE_DIGITO", "DIGITO_AGENCIA", "CEP", "BAIRRO", "ENDERECO", "NUMERO", "CIDADE", "UF", "UF_UNIDADE") AS 
  select
