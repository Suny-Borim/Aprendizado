  ...
  CREATE OR REPLACE VIEW ACOMP_VAGAS_CONTATO_AGENDADO ("CONTRATO", "CODIGO_DA_VAGA", "VAGA_PP", "TIPO_VAGA", "DATA_CRIACAO", "ID_PCD", "SITUACAO", "LIMITE_MIN_ENCAMINHADOS_VAGA", "ENCAMINHADOS", "DATA_ULTIMO_CONTATO", "DATA_AGENDAMENTO", "DATA_PROCESSO_SELETIVO", "ALERTA") AS 
  (
  ...
  CREATE OR REPLACE VIEW ACOMP_VAGAS_RES_ASSISTENTE ("CONTRATO", "CODIGO_DA_VAGA", "VAGA_PP", "TIPO_VAGA", "DATA_CRIACAO", "ID_PCD", "DIAS_RET_ASSISTENTE", "DATA_ENVIO", "ASSISTENTE", "ALERTA") AS 
  (
  ...
  CREATE OR REPLACE VIEW V_ACOMPANHAMENTOS_GMC ("CONTRATO", "EMPRESA", "PERIODO", "TIPO_ACOMPANHAMENTO", "QTD_PRORROGADOS_TRATADOS", "QTD_PRORROGADOS_NAO_TRATADOS", "QTD_REPOSTOS_TRATADOS", "QTD_REPOSTOS_NAO_TRATADOS", "QTD_RESCINDIDOS_TRATADOS", "QTD_RESCINDIDOS_NAO_TRATADOS", "QTD_VENCIDOS") AS 
  (
    (select DISTINCT gmc.id_contrato CONTRATO, gmc.NOME_EMPRESA EMPRESA, gmc.tipo_periodo PERIODO, gmc.tipo_acompanhamento TIPO_ACOMPANHAMENTO,
        (SELECT COUNT(*)     
            ...
            WHERE                 
                EXISTS (SELECT acomp.ID_CONTR_EMP_EST FROM ACOMPANHAMENTOS_CONTRATADOS acomp
        ...
        (SELECT COUNT(*)     
            ...
            INNER JOIN REP_CONTRATOS contrato ON acomp_gmc.id_contrato = contrato.id  
            WHERE  
                NOT EXISTS (SELECT acomp.ID_CONTR_EMP_EST FROM ACOMPANHAMENTOS_CONTRATADOS acomp
                            WHERE acomp.ID_CONTR_EMP_EST = cee.id  
                            AND acomp.TIPO_PROCESSO = 1
                            AND acomp.TIPO_REGISTRO = 0)
