...
BEGIN
    ...
    FOR c_vaga IN (SELECT codigo_da_vaga
                   ...
                   WHERE TIPO_VAGA = 'A'
                     ...
                     and stage_objetivo_vaga(codigo_da_vaga, 'A') > 0 )

        LOOP

            V_CODIGO_DA_VAGA := c_vaga.codigo_da_vaga;
            v_stage_objetivo_vaga := stage_objetivo_vaga(V_CODIGO_DA_VAGA, 'A');
                  ...
                  WHERE V.TIPO_VAGA = 'A'
                    ...
                    AND (E.CONTRATOS_EMPRESA IS EMPTY OR E.CONTRATOS_EMPRESA IS NULL OR NOT EXISTS(SELECT 1
                                                                                                   ...
                                                                                                   WHERE EC_EMP.ID_EMPRESA = V.ID_EMPRESA
                                                                                                      OR ((EC_EMP.SITUACAO in (0,3,4,5) OR
                                                                                                           exists(
                                                                                                                   select 1
                    ...
                    AND (V.data_triagem < E.data_alteracao OR V.data_triagem is null)
                  ORDER BY E.QUALIFICACAO_VULNERAVEL DESC,
                           E.QTD_CONVOCACOES) t3;

            IF (stage_objetivo_vaga (V_CODIGO_DA_VAGA, 'A') = 0) THEN
