CREATE OR REPLACE VIEW V_VAGAS_VINCULADAS_ESTUDANTE ("ID_ESTUDANTE", "CODIGO_VAGA", "ID_LOCAL_CONTRATO", "CNPJ", "TIPO_VAGA", "TIPO_DIVULGACAO", "AREA_PROFISSIONAL", "AREA_ATUACAO", "CURSO_CAPACITACAO", "VALOR_BOLSA", "VALOR_BOLSA_DE", "VALOR_BOLSA_ATE", "TIPO_VALOR_BOLSA", "LATITUDE_EMPRESA", "LONGITUDE_EMPRESA", "BENEFICIOS", "ID_PCD", "NOME_EMPRESA_PJ", "NOME_EMPRESA_PL", "SIGLA", "SITUACAO_VINCULO", "OCORRENCIAS") AS
  (
    SELECT VINC_E.ID_ESTUDANTE as ID_ESTUDANTE,
            ...
            GROUP BY ID_ESTUDANTE, CODIGO_VAGA, VAGA_E.ID_LOCAL_CONTRATO, CNPJ, 'ESTAGIO', TIPO_DIVULGACAO, DESCRICAO_AREA_PROFISSIONAL,
                     VALOR_BOLSA_FIXO, VALOR_BOLSA_DE, VALOR_BOLSA_ATE, TIPO_VALOR_BOLSA, LATITUDE, LONGITUDE, PCD.ID, loc_c.razao_social,loc_c.nome, SIT.SIGLA, SITUACAO_VINCULO
            UNION
            ...
            GROUP BY ID_ESTUDANTE, CODIGO_VAGA, VAGA_A.ID_LOCAL_CONTRATO, CNPJ, 'APRENDIZ', TIPO_DIVULGACAO, ID_AREA_ATUACAO_APRENDIZ, NOME_CURSO,
                     VALOR_SALARIO, VALOR_SALARIO_DE, VALOR_SALARIO_ATE, TIPO_SALARIO_VALOR, END.LATITUDE, END.LONGITUDE, PCD.ID, loc_c.razao_social,loc_c.nome, SIT.SIGLA, SITUACAO_VINCULO
       );