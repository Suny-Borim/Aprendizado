    ...
    (
        ...
        from (
                 SELECT con.codigo_estudante
                      ...
                      , con.DATA_ALTERACAO
                      , con.VALOR_BOLSA
                      , case when lc.VALOR_CI is null then rdcc.VALOR_CONTRIBUICAO else null end VALOR_PERCENTUAL_BASE
                      , lc.VALOR_CI
                      , re.duracao_curso
                 ...
                 FROM CONTRATOS_ESTUDANTES_EMPRESA con
                          ...
                          left join rep_dados_contribuicao_company rdcc  on rdcc.ID_CONTRATO = lc.ID_CONTRATO and rdcc.ID_TIPO_CONTRIBUICAO = 2
                 ...
                 group by con.codigo_estudante, con.ID_LOCAL_CONTRATO, con.ID, con.data_inicio_estagio,
                          ...
                          con.VALOR_BOLSA,  case when lc.VALOR_CI is null then rdcc.VALOR_CONTRIBUICAO else null end , lc.VALOR_CI, re.duracao_curso, con.CEP_EMPRESA,
