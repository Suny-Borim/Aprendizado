...
BEGIN
    ...
    FOR c_vaga IN (SELECT codigo_da_vaga FROM SERVICE_VAGAS_DEV."TRIAGENS_VAGAS" WHERE stage_objetivo_vaga (codigo_da_vaga) > 0)
            ...
            FROM
                (SELECT /*+ PARALLEL(8) */
                 ...
                 WHERE
                   ...
                   AND NOT EXISTS (SELECT 1 FROM SERVICE_VAGAS_DEV.STG_VINCULOS_VAGA t WHERE t.codigo_vaga = V.codigo_da_vaga AND t.id_estudante = E.ID_ESTUDANTE AND t.deletado = 0 AND t.SITUACAO_VINCULO <> 3)
