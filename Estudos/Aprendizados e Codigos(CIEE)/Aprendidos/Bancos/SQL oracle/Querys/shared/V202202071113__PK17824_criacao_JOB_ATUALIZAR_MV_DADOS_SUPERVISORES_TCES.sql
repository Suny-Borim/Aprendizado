  ...
  Select count(*) into JOB_EXISTENTE
    ...
    if (JOB_EXISTENTE = 0) then
      execute immediate 'BEGIN
        ...
        job_action          => Q''[BEGIN DBMS_MVIEW.REFRESH(''SERVICE_VAGAS_DEV.JOB_ATUALIZAR_MV_DADOS_SUPERVISORES_TCES''); END;]'',
        ...
        enabled             => TRUE,
        auto_drop           => FALSE,
        comments            => ''Refresh MV SERVICE_VAGAS_DEV.JOB_ATUALIZAR_MV_DADOS_SUPERVISORES_TCES''
        );
		END;';
    else
    execute immediate 'BEGIN
