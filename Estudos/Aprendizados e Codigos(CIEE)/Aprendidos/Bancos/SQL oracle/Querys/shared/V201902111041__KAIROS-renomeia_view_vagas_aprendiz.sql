--*************************************************************************
--CRIA UMA VIEW COM CAMPOS NECESSÃ€RIOS PARA A CONSULTA DE VAGAS APRENDIZ*
--*************************************************************************
DROP VIEW {{user}}.VIEW_VAGAS_APRENDIS;

CREATE OR REPLACE FORCE VIEW {{user}}.V_VAGAS_APRENDIS AS
  SELECT
    v.ID,
