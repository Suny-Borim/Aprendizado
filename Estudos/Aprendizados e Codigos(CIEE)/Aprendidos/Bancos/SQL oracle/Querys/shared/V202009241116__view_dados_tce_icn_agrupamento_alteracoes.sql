create or replace view V_DADOS_TCE_ICN as
        ...
        select rownum                                                 as id
             ...
             , tce.data_alteracao
             , tce.data_rescisao
             , SUBSTR2(tce.motivo_rescisao, 0, 100)                   as motivo_rescisao
             , SUBSTR2(tce.motivo_cancelamento, 0, 100)               as motivo_cancelamento
        ...
        from (
                 ...
                 having max(con.seq_ta) = con.SEQ_TA
             ) tce
;