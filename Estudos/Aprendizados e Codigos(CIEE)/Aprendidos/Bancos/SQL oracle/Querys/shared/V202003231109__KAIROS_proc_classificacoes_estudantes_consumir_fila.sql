...
BEGIN
    ...
    VALUES (seq_classificacoes_estudantes_log.NEXTVAL, current_timestamp, current_timestamp, 
            VAR_PROCEDURE,VAR_PROCEDURE,0, 
            var_temp_est, null, var_inicio_processo, current_timestamp);
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        VALUES (seq_classificacoes_estudantes_log.NEXTVAL, current_timestamp, current_timestamp, 
                VAR_PROCEDURE,VAR_PROCEDURE,0, 
                var_temp_est, null, var_inicio_processo, current_timestamp, var_mensagem);
