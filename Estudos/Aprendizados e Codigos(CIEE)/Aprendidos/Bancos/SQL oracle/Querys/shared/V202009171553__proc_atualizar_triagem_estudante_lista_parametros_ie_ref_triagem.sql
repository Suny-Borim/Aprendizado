...
BEGIN
    ...
    SERVICE_VAGAS_DEV.proc_atualizar_triagem_estudante_lista_carga_horaria_diaria(V_IDS_ESTUDANTES_INTERNO);
    SERVICE_VAGAS_DEV.proc_atualizar_triagem_estudante_lista_permissao_estagio(V_IDS_ESTUDANTES_INTERNO);
    SERVICE_VAGAS_DEV.proc_atualizar_triagem_estudante_lista_area_atuacao(V_IDS_ESTUDANTES_INTERNO);
