...
BEGIN
    ...
    MERGE INTO {{user}}."TRIAGENS_VAGAS" D
        ...
        V.CODIGO_DA_VAGA,PROC_INDEXA_CONHECIMENTOS_ESTUDANTE
        ...
        from {{user}}.APARELHOS_PCD_APRENDIZ APARELHO
        ...
        FROM {{user}}.VINCULO_QUALI_VAGA_APRENDIZ VQVE
        ...
        WHEN EXISTS(
        SELECT 1
        FROM {{user}}.OCORRENCIAS_APRENDIZ OCORRENCIA
