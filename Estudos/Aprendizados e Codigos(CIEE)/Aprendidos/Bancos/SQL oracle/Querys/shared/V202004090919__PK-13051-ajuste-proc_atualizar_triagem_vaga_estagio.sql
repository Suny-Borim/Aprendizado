...
BEGIN
    ...
    INSERT
        ...
        VALUES
    (S.ID_UNIDADE_CIEE, S.CODIGO_DA_VAGA, S.SEMESTRE_INICIAL, S.SEMESTRE_FINAL, S.SEXO, S.RESERVISTA, S.FUMANTE,
     S.POSSUI_CNH, S.EMPRESA_COM_ACESSIBILIDADE, S.VALIDO_COTA, S.ESTADO_CIVIL, S.IDIOMAS, S.ESCOLAS, S.PCDS,
     S.POSSUI_PCD, S.RECURSOS_ACESSIBILIDADE, S.PRIORIZA_VULNERAVEL, S.QUALIFICACOES, S.CONHECIMENTOS, S.CURSOS,
     S.ENDERECO, S.ENDERECO_GEOHASHS, S.CAPACITACAO, S.CAPACITACAO_GEOHASHS, S.TIPO_HORARIO_ESTAGIO, S.HORARIO_ENTRADA,
     S.HORARIO_SAIDA, S.VALOR_RAIO, S.LOCALIZACAO, S.IDADE_MINIMA, S.IDADE_MAXIMA, S.SITUACAO_ESCOLARIDADE,
     S.ESCOLARIDADE, S.DATA_CONCLUSAO, S.TIPO_VAGA, S.ID_EMPRESA, S.CODIGO_AREA_PROFISSIONAL, S.VALOR_BOLSA_FIXO,
     S.VALOR_BOLSA_DE, S.VALOR_BOLSA_ATE, S.AREAS_ATUACAO_ESTAGIO, S.POSSUI_OCORRENCIAS, S.NOME_RAZAO_EMPRESA,
     S.ID_LOCAL_CONTRATO, S.DATA_ABERTURA, S.DESCRICAO_VAGA, sysdate /*DATA_ALTERACAO*/
        , S.QTD_CONVOCADOS, S.ID_SITUACAO_VAGA, S.CLASSIFICACAO_OBTIDA, S.PONTUACAO_OBTIDA);
END;
/