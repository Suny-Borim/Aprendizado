...
BEGIN
    ...
    MERGE INTO {{user}}."TRIAGENS_VAGAS" D
        ...
        AND vinculos.SITUACAO_VINCULO <> 3)                                         "QTD_CONVOCADOS",
        V.ID_SITUACAO_VAGA,
        ...
        LEFT JOIN {{user}}.qualificacoes_empresas_consolidado cec on CEC.ID_EMPRESA = INF_EMP.ID_EMPRESA
        ...
        AND (cec.deletado is null or cec.deletado = 0)
        AND CEC.ID_LOCAL_CONTRATO IS NULL OR CEC.ID_LOCAL_CONTRATO  = LOC.ID
        ) S
