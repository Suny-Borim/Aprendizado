 CREATE OR REPLACE FORCE EDITIONABLE VIEW "SERVICE_VAGAS_DEV"."ACOMP_VAGAS_RES_ASSISTENTE" ("CONTRATO", "CODIGO_DA_VAGA", "VAGA_PP", "TIPO_VAGA", "DATA_CRIACAO", "ID_PCD", "DIAS_RET_ASSISTENTE", "DATA_ENVIO", "ASSISTENTE", "ALERTA") AS  
