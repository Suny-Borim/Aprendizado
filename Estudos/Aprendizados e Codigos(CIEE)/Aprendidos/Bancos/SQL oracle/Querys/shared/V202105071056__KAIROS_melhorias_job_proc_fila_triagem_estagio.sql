BEGIN
    dbms_scheduler.create_job('"JOB_PROC_FILA_TRIAGEM_VAGA_ESTAGIO"',
                              job_type=>'PLSQL_BLOCK', job_action=>'BEGIN
                                            proc_processa_fila_triagem_vaga_estagio();
                              ...
                              enabled=>TRUE,
                              auto_drop=>FALSE,
                              comments=>'JOB que processa a fila da triagem de vagas estagio'
        );
END;