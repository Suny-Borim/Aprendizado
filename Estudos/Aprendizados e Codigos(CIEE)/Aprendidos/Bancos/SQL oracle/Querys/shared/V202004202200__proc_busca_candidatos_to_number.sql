    ...
    ELSE
        ...
        IF (P_REFERENCIA_DISTANCIA IN (2, 5, 6)) THEN
            ...
            IF (v_cap2_referencia IS NOT NULL) THEN
                ...
                END IF;
            ELSE
                l_query := l_query || '(:v_geohash_cap2 IS NULL AND :p_referencia_cap2 is null and :p_valor_raio is not null))';
            END IF;
            ...
            ELSE
                l_query := l_query || '(:v_geohash_cap3 IS NULL AND :p_referencia_cap3 is null and :p_valor_raio is not null))';
            END IF;
